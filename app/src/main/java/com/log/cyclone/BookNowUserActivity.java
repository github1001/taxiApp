                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (latitude == 0 && longitude == 0) {
                                    try {
                                        ...
                                        Log.d("BOOK_NOW_PICK_UP", "Cannot use the location service at the moment. Using default values instead.");
                                ...
                                if (drop_latitude == 0 && drop_longitude == 0) {
                                    try {
                                        ...
                                        Log.d("BOOK_NOW_DROP", "Cannot use the location service at the moment. Using default values instead.");

                                        latitude = Globals.DEFAULT_DROP_LATITUDE;
                                        longitude = Globals.DEFAULT_DROP_LONGITUDE;
                                    }
                                }
    ...
    class NewRequest {
        ...
        public void execute() {
            ...
            try {
                ...
                Log.d("BOOKING_TIME", "Cannot read date time value from the field Using current time instead.");
