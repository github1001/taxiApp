...
public class BookNowDriverActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapterHour = ArrayAdapter.createFromResource(this, R.array.bookingtime_hour, android.R.layout.simple_spinner_item);
        adapterHour.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spHour.setAdapter(adapterHour);

        ArrayAdapter<CharSequence> adapterMin = ArrayAdapter.createFromResource(this, R.array.bookingtime_minute, android.R.layout.simple_spinner_item);
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (name.equalsIgnoreCase("") || PhnNumber.equalsIgnoreCase("") || address.equalsIgnoreCase("") || destination.equalsIgnoreCase("") || numPassengers.equalsIgnoreCase("")) {
                            ...
                            try {
                                ...
                                Log.d("REQUEST_TAXT_DRIVER", "Cannot request taxt. An error occurred!" + e.getLocalizedMessage());

                                // Create dummy values for pickup and drop locations.
                                latitude = Globals.DEFAULT_LATITUDE;
                                longitude = Globals.DEFAULT_LONGITUDE;
                                drop_latitude = Globals.DEFAULT_DROP_LATITUDE;
                                drop_longitude = Globals.DEFAULT_DROP_LONGITUDE;
                            }
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (name.equalsIgnoreCase("") || PhnNumber.equalsIgnoreCase("") || address.equalsIgnoreCase("") || destination.equalsIgnoreCase("") || numPassengers.equalsIgnoreCase("")) {
                    ...
                    try {
                        ...
                        Log.d("REJECT_TAXI_REQUEST", "Cannot reject request. An error occurred!" + e.getLocalizedMessage());
    ...
    class RequestTaxi {
        ...
        public void execute() {
            ...
            try {
                ...
                Log.d("GET_BOOK_DATE", "Cannot retrieve bookDate value. Using dummy values instead.");
